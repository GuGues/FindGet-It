...
<div class="detail-container">
    ...
    <div class="info-section">
        ...
        <div class="image-container">
            <c:if test="${ item.fdfilepathimg == 'null' }">
                <img src="/img/noimg.png" alt="이미지가 없습니다">
            </c:if>
            <c:if test="${ item.fdfilepathimg !='null'}">
                <img src="${item.fdfilepathimg}" alt="이미지가 없습니다"> </c:if>
            <div class="no-image"></div>
        </div>

        <!-- 상세 정보 섹션 -->
        <div class="info-content">
            <div class="info" id="info-header"><span class="label">제목</span><c:out value="${item.fdsbjt}"/></div>
            <div class="info"><span class="label">물품명</span><c:out value="${item.fdprdtnm}"/></div>
            <div class="info"><span class="label">관리ID</span><c:out value="${item.atcid}"/></div>
            <div class="info"><span class="label">습득일자</span><c:out value="${item.fdsbjt}"/></div>
            ...
            <div class="info"><span class="label">물품색상</span><c:out value="${item.clrnm}"/></div>
    ...
    <div class="content-container">
        ...
        <div class="btn-container2">
            <button class="policeList">목록</button>
        </div>
    </div>
...
<script>
    ...
    var keyword = "<c:out value='${item.depplace}'/>";
    ...
    const listBtn = document.querySelector('.policeList')
    listBtn.addEventListener('click', function () {
        window.location.href = '/police/found';
    })
</script>
</body>
</html>