  ...
  <main>
    <div class="titleBox">
      <div class="right" style="font-size: 13px;">
        <a href="/">HOME</a>&nbsp;&gt;&nbsp;<a href="/lost">게시물관리</a>&nbsp;&gt;&nbsp;<a href="/admin/post/ban">차단게시글</a>
      </div>
      <h3 class="title">게시물관리</h3>
    </div>
    <hr style="color: #8C6C55; border-width: 3px;">
    <div><h4 style="padding-left: 20px; margin-bottom: 20px;">차단 게시물 목록</h4></div>
...
<div class="modal">
    <div class="modal_content">
      ...
      <span class="banBtn btn">블라인드 해제</span>
