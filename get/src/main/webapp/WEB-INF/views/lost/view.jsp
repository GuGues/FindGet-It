...
<div class="detail-container">
  ...
  <div class="detail-header">
    ...
    <h4>소중한 물품을 분실하셨습니다.
      <br>
      아래와 같은 물품을 습득하셨다면 관할기관 신고나 채팅으로 연락 부탁드립니다.</h4>
    </div>
  </div>
  ...
  <div class="info-section">
    ...
    <div class="info-content">
      <div class="info">
        <span class="label">분실물명:</span> <c:out value="${item.lostTitle}"/>
      </div>
      <div class="info">
        <span class="label">관리번호:</span> <c:out value="${item.lostIdx}"/>
      </div>
      <div class="info">
        <span class="label">분실일:</span> <c:out value="${item.lostDate}"/>
      </div>
      <div class="info">
      ...
      <div class="info">
        <span class="label">사례금:</span> <c:out value="${item.reward}"/>
      </div>
    </div>
  </div>
