...
public class searchController {
	...
	public ModelAndView getSearch(@RequestParam Map<String, String> map, @RequestParam(value = "page", defaultValue = "1") int page){
		...
		List<lostVo> searchLost = lostMapper.getSearchLost(map);
